...
export const DATA = {
  ...
  contact: {
    email: "dhandy.pf@gmail.com",
    tel: "+6281804208860",
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/DhandyPF",
        icon: Icons.github,
        navbar: true,
      },
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/dhandy-putra-fahruddin-931011383/",
        icon: Icons.linkedin,
        navbar: true,
      },
      ...
      links: [
        {
          ...
          href: "https://www.dicoding.com/certificates/1OP8JMONLPQK",
        },
      ],
    },
    {
      title: "Memulai Pemrograman Dengan C",
      dates: "December 14th, 2025",
      // location: "San Francisco, California",
      description:
        "Developed a web application which aggregates social media data regarding cryptocurrencies and predicts future prices.",
      image: "/dicoding.jpg",
      links: [
        {
          title: "Dicoding",
          icon: <Icons.github className="h-4 w-4" />,
          href: "https://www.dicoding.com/certificates/4EXG3GMNQZRL",
        },
      ],
    },
  ],
